...
const menuConfig = {
  guest: [
    { label: "Find Photos", path: "/findingPhotos", icon: "ri-image-search-line" },
    { label: "My Access", path: "/guest", icon: "ri-user-line" },
  ],

  photographer: [
    { label: "Dashboard", path: "/photographer", icon: "ri-dashboard-line" },
    { label: "Create Album", path: "/photographer/create", icon: "ri-add-box-line" },
    { label: "My Albums", path: "/photographer/albums", icon: "ri-image-line" },
    { label: "Guests", path: "/photographer/guests", icon: "ri-group-line" },
  ],

  admin: [
    { label: "Admin Dashboard", path: "/admin", icon: "ri-shield-user-line" },
    { label: "Photographers", path: "/admin/photographers", icon: "ri-camera-line" },
